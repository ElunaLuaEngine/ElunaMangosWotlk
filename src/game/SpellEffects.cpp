...
void Spell::EffectLeapForward(SpellEffectIndex eff_idx)
{
    ...
    // falling case
    if (unitTarget->m_movementInfo.HasMovementFlag(MOVEFLAG_FALLING) && !unitTarget->GetMap()->GetHeightInRange(unitTarget->GetPhaseMask(), prevPos.x, prevPos.y, groundZ, 3.0f))
    {
